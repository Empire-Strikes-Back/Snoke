      ...
      (when-let [value (<! ops|)]
        (condp = (:op value)
          ...
          (let [{:keys [frequency role]} value
                ...
                games-topic (Snoke.corn/encode-base64url-u "raisins")
                game-topic (Snoke.corn/encode-base64url-u frequency)
                _ (Snoke.corn/subscribe-process
                   {:sub| sub|
                    :cancel| cancel-sub|
                    :frequency frequency
